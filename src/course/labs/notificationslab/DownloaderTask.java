		...
		mApplicationContext.sendOrderedBroadcast(new Intent(MainActivity.DATA_REFRESHED_ACTION), null, new BroadcastReceiver() {
			...
			public void onReceive(Context context, Intent intent) {
				...
				if (Activity.RESULT_OK != getResultCode()) {
					...
					final PendingIntent pendingIntent = PendingIntent.getBroadcast(context, Activity.RESULT_OK, restartMainActivtyIntent, PendingIntent.FLAG_UPDATE_CURRENT);
					...
					Builder notificationBuilder = new Builder(mApplicationContext);
